...
comparable mass-ratio (q=3) to large mass-ratio regime (q=10000) and are tuned 
...
from the dominant [(2,2)] mode of radiation. 
...
Available modes are [(2,2),(2,1),(3,1),(3,2),(3,3),(4,2),(4,3),(4,4),(5,3),
(5,4),(5,5),(6,4),(6,5),(6,6),(7,5),(7,6),(7,7),(8,6),(8,7),(8,8),(9,7),(9,8),(9,9),(10,8),(10,9)]. The m<0 modes are deduced from the m>0 modes.

# Available Models

1. BHPTNRSur1dq1e4

Currently, this package supports one model, EMRISur1dq1e4,
